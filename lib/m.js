          ...
          while (1) switch (_context2.n) {
            ...
            case 1:
              return _context2.a(2, new Promise(function (resolve, reject) {
                try {
                  _this3.process = spawn(_this3.config.command, _this3.config.args || [], {
...
var BrowserSecurityManager = /*#__PURE__*/function () {
  ...
  return _createClass(BrowserSecurityManager, [{
    ...
    value: function loadSecurityRules() {
      ...
      try {
        // 尝试加载自定义安全规则文件
        var rulesFile = join(process.cwd(), 'browser-security-rules.json');
        if (existsSync(rulesFile)) {
          var rules = JSON.parse(readFileSync(rulesFile, 'utf-8'));
      ...
      var _saveScreenshotToFile = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(screenshotData, filePath) {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 1:
              _context6.n = 2;
              return fs.writeFile(filePath, screenshotData);
            case 2:
              _context6.n = 4;
              break;
            case 3:
...
var MCPBrowserServer = /*#__PURE__*/function () {
  ...
  return _createClass(MCPBrowserServer, [{
    ...
    value: function setupHandlers() {
      var _this = this;
      // 工具列表处理器
      this.server.setRequestHandler(ListToolsRequestSchema, /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              return _context.a(2, {
      ...
      // 工具调用处理器
      this.server.setRequestHandler(CallToolRequestSchema, /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(request) {
          ...
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.p = _context2.n) {
              ...
              case 3:
                _context2.n = 4;
                return _this.toolSystem.toolManager.executeLocalTool('browser.navigate', args, "mcp-".concat(Date.now()));
              case 4:
                result = _context2.v;
                return _context2.a(3, 18);
              case 5:
                _context2.n = 6;
                return _this.toolSystem.toolManager.executeLocalTool('browser.extract', args, "mcp-".concat(Date.now()));
              case 6:
                result = _context2.v;
                return _context2.a(3, 18);
              case 7:
                _context2.n = 8;
                return _this.toolSystem.toolManager.executeLocalTool('browser.click', args, "mcp-".concat(Date.now()));
              case 8:
                result = _context2.v;
                return _context2.a(3, 18);
              case 9:
                _context2.n = 10;
                return _this.toolSystem.toolManager.executeLocalTool('browser.type', args, "mcp-".concat(Date.now()));
              case 10:
                result = _context2.v;
                return _context2.a(3, 18);
              case 11:
                _context2.n = 12;
                return _this.toolSystem.toolManager.executeLocalTool('browser.screenshot', args, "mcp-".concat(Date.now()));
              case 12:
                result = _context2.v;
                return _context2.a(3, 18);
              case 13:
                _context2.n = 14;
                return _this.toolSystem.toolManager.executeLocalTool('browser.evaluate', args, "mcp-".concat(Date.now()));
              case 14:
                result = _context2.v;
                return _context2.a(3, 18);
              case 15:
...
export { AgentCore, BROWSER_ENGINES, BROWSER_TOOLS, BaseBrowserTool, BrowserInstance, BrowserInstancePool$1 as BrowserInstancePool, BrowserSecurityManager, BrowserSecurityPolicy, BrowserToolChain, BrowserToolManager, BrowserToolMonitor$1 as BrowserToolMonitor, CONNECTION_STATUS, ClickTool, DEFAULT_SECURITY_CONFIG, EvaluateTool, ExtractTool, LLM, LLMFactory, MCPBrowserClient, MCPBrowserServer, MCPClient, MCPConnectionManager, MCPToolSystem, NavigateTool, PRESET_CONFIGS, PROMPT_TEMPLATES, PromptBuilder, RISK_LEVELS, SECURITY_LEVELS, SMART_AGENT_PRESETS, ScreenshotTool, SelectorBuilder, SelectorPatterns, TOOL_STATUS, TypeTool, analyzePage, batchProcess, combineSelectors, createAgent, createAssistantPrompt, createBrowserInstancePool, createBrowserSecurityManager, createBrowserToolChain, createBrowserToolManager, createBrowserToolMonitor, createBrowserToolSystem, createFunctionPrompt, createLLMAgent, createMCPAgent, createMCPBrowserClient, createMCPBrowserServer, createMCPClient, createMCPConnectionManager, createMCPSystem, createOpenAIAgent, createOpenAILLM, createPresetAgent, createSelectorBuilder, createSmartAgent, createSparkAgent, createSparkLLM, createSystemPrompt, createUserPrompt, detectSelectorType, executeWorkflow, getSupportedTools, isValidCSSSelector, isValidXPathSelector, llmStreamRequest, manipulateDOM, normalizeSelector, openaiRequestHandler, quickStart, sparkRequestHandler, sparkStreamRequest, startMCPBrowserServer };
