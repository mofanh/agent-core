(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('child_process'), require('events'), require('@modelcontextprotocol/sdk/client/index.js'), require('@modelcontextprotocol/sdk/client/stdio.js'), require('url'), require('crypto'), require('fs'), require('path'), require('fs/promises'), require('@modelcontextprotocol/sdk/server/index.js'), require('@modelcontextprotocol/sdk/server/stdio.js'), require('@modelcontextprotocol/sdk/types.js')) :
  typeof define === 'function' && define.amd ? define(['exports', 'child_process', 'events', '@modelcontextprotocol/sdk/client/index.js', '@modelcontextprotocol/sdk/client/stdio.js', 'url', 'crypto', 'fs', 'path', 'fs/promises', '@modelcontextprotocol/sdk/server/index.js', '@modelcontextprotocol/sdk/server/stdio.js', '@modelcontextprotocol/sdk/types.js'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.AgentCore = {}, global.child_process, global.events, global.index_js, global.stdio_js, global.url, global.crypto, global.fs, global.path, global.fs$1, global.index_js$1, global.stdio_js$1, global.types_js));
})(this, (function (exports, child_process, events, index_js, stdio_js, url, crypto, fs, path, fs$1, index_js$1, stdio_js$1, types_js) { 'use strict';
