define(['require', 'exports', 'child_process', 'events', '@modelcontextprotocol/sdk/client/index.js', '@modelcontextprotocol/sdk/client/stdio.js', 'url', 'crypto', 'fs', 'path', 'fs/promises', '@modelcontextprotocol/sdk/server/index.js', '@modelcontextprotocol/sdk/server/stdio.js', '@modelcontextprotocol/sdk/types.js'], (function (require, exports, child_process, events, index_js, stdio_js, url, crypto, fs, path, fs$1, index_js$1, stdio_js$1, types_js) { 'use strict';
          ...
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.p = _context2.n) {
              case 0:
                _context2.p = 0;
                _context2.n = 1;
                return new Promise(function (resolve, reject) { require(['puppeteer'], function (m) { resolve(/*#__PURE__*/_interopNamespaceDefault(m)); }, reject); });
              case 1:
          ...
          return _regenerator().w(function (_context3) {
            while (1) switch (_context3.p = _context3.n) {
              case 0:
                _context3.p = 0;
                _context3.n = 1;
                return new Promise(function (resolve, reject) { require(['playwright'], function (m) { resolve(/*#__PURE__*/_interopNamespaceDefault(m)); }, reject); });
              case 1:
